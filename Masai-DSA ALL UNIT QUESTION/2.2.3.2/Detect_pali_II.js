...
// You are free to rearrange the string in any way you want. Rearrangement refers to 
// the fact that the characters can be arranged in any way in the string.
...
// Output
// If the string can be rearranged into a palindrome, print "Possible!", else print 
// "Not Possible!".
